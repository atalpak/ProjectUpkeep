...
| 10 | Mobile UI refinement brief (7 items) | Varies | Medium | Priority 1 done (2026-09-23) — unified Mort-centered header; Priorities 2–7 still open | `apps/mobile/src/components/AppHeader.tsx` + brief |
