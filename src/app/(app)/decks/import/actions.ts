...
/**
 * The deck's current entries for the printings we are about to touch, keyed by
 * printing id. Importing a printing the deck already lists bumps that entry;
 * a different printing of the same card is a new row, by design — a decklist
 * can want 14 of one Forest art and 6 of another.
 */
