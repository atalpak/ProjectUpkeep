...
test("settings: any input yields a complete valid object; the OS reduced-motion preference always wins", () => {
  ...
  const mixed = sanitizeSettings({ cardSize: "huge", handSize: "large", maxVisibleHand: 9999, playmat: "nope", sleeve: "plum", motion: "full", foil: "yes" });
  ...
  assert.equal(mixed.foil, DEFAULT_SETTINGS.foil);
